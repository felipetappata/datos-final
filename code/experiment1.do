...
if "`1'" == "" | "`2'" == "" | "`3'" == "" {
    display as error "Usage: stata -b do experiment1.do N model rho [output_dir]"
...
// ========================================================================
// SIMULATION PARAMETERS - EXPERIMENT 1: VERY SHORT T (T=4)
// ========================================================================

// EXPERIMENT 1 MODIFICATION: Shorter time dimension
local T 4                    // CHANGED: Time periods for estimation (T=4 instead of T=7)
local T_total 17             // CHANGED: Total periods generated (17 instead of 20)
local T_discard 13           // Periods to discard for initial conditions (unchanged)
...
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 1: VERY SHORT T (T=4) - ENDOGENOUS SELECTION"
display as text "========================================================================="
display as text "Parameters: N=`N', Model=`model', rho=`rho', Replications=`reps'"
display as text "EXPERIMENT: Very short T (T=`T' instead of baseline T=7)"
...
forvalues rep = 1/`reps' {
    ...
    // ====================================================================
    // DATA GENERATION PROCESS (Same as baseline except for T dimensions)
    // ====================================================================
...
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 1 SIMULATION COMPLETED"
display as text "========================================================================="
...
matrix Results[1,9] = 1

// Display final results table
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 1 FINAL RESULTS - VERY SHORT T (T=4)"
display as text "Model `model', N=`N', rho=`rho'"
display as text "========================================================================="
matrix list Results, format(%9.6f)

// Export results to text file for easier reading
local txt_filename "`output_dir'/exp1_model`model'_N`N'_rho`rho'.txt"
file open txtfile using "`txt_filename'", write replace
file write txtfile "=========================================================================" _n
file write txtfile "EXPERIMENT 1: VERY SHORT T (T=4) - TABLE 2 REPLICATION" _n
file write txtfile "AL SADOON ET AL. (2019) - ENDOGENOUS SELECTION RESULTS" _n
file write txtfile "=========================================================================" _n
file write txtfile "Experiment: Very short T (T=4 instead of baseline T=7)" _n
...
local filename "exp1_model`model'_N`N'_rho`rho'.dta"
preserve
clear
...
svmat Results, names(col)
gen str model = "`model'"
gen str experiment_type = "exp1_short_T"
gen str date_time = "`c(current_date)' `c(current_time)'"
local csv_filename "`output_dir'/exp1_model`model'_N`N'_rho`rho'.csv"
...
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 1 COMPLETE FOR N=`N', MODEL=`model', RHO=`rho'"
display as text "========================================================================="
