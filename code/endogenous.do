/* ========================================================================= 
   REPLICATION OF AL SADOON ET AL. (2019) TABLE 1 - ENDOGENOUS SELECTION
   =========================================================================
   
   This script replicates the "Endogenous selection" columns of Table 1
   from Al Sadoon et al. (2019), examining the performance of AB and System 
   GMM estimators in dynamic panel models with endogenous sample selection.
   
   Command line usage:
   stata -b do endogenous.do N model rho
   ...
   Example: stata -b do endogenous.do 500 A 0.25
...
display as text ""
display as text "========================================================================="
display as text "MONTE CARLO SIMULATION - ENDOGENOUS SELECTION"
display as text "========================================================================="
...
forvalues rep = 1/`reps' {
    ...
    // ====================================================================
    // ESTIMATION (UNCORRECTED FOR SELECTION)
    // ====================================================================
...
if `ab_valid' >= 10 {
    ...
    display as text "  Paper prediction: Should be approximately unbiased"
}
else {
    scalar ab_mean = .
    scalar ab_sd = .
...
if `sys_valid' >= 10 {
    ...
    display as text "  Paper prediction: Should have small bias (1-2.5%)"
}
else {
    scalar sys_mean = .
    scalar sys_sd = .
...
display as text ""
display as text "========================================================================="
display as text "FINAL RESULTS - ENDOGENOUS SELECTION"
...
file write txtfile "" _n
file write txtfile "Paper Predictions (Endogenous selection):" _n
file write txtfile "  AB: Should be approximately unbiased (consistent)" _n
file write txtfile "  SYS: Should have small bias (1-2.5% for this rho)" _n
file write txtfile "" _n
file write txtfile "=========================================================================" _n
file close txtfile
...
capture append using "output/partial/master_results_endogenous.dta"
save "output/partial/master_results_endogenous.dta", replace

// Export to CSV for easy reading
export delimited using "output/partial/master_results_endogenous.csv", replace
restore
