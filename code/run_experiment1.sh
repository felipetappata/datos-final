...
# ==============================================================================
# RUN EXPERIMENT 1 (SHORT T) - TABLE 2 REPLICATION 
# ==============================================================================
# This script runs Experiment 1 (Very short T, T=4) for all combinations of:
# - Models: A (static), B (dynamic) 
# - Autoregressive parameters: 0.25, 0.50, 0.75
# For a specified sample size N.
#
# Usage: bash run_experiment1.sh N
# Example: bash run_experiment1.sh 500
# ==============================================================================

# Check if N parameter is provided
if [ $# -eq 0 ]; then
    echo "Error: Please provide sample size N as argument"
    echo "Usage: bash run_experiment1.sh N"
    echo "Example: bash run_experiment1.sh 500"
    exit 1
fi
...
echo "========================================================================"
echo "STARTING EXPERIMENT 1: VERY SHORT T (T=4) - TABLE 2 REPLICATION"
echo "========================================================================"
...
echo "Starting all Experiment 1 specifications in parallel for N=$N..."
echo "Output directory: $OUTPUT_DIR"
echo ""

# Run all 6 combinations in parallel
$STATA -b experiment1.do $N A 0.25 $OUTPUT_DIR &
$STATA -b experiment1.do $N A 0.50 $OUTPUT_DIR &
$STATA -b experiment1.do $N A 0.75 $OUTPUT_DIR &
$STATA -b experiment1.do $N B 0.25 $OUTPUT_DIR &
$STATA -b experiment1.do $N B 0.50 $OUTPUT_DIR &
$STATA -b experiment1.do $N B 0.75 $OUTPUT_DIR &
...
echo "File pattern: exp1_model[A|B]_N$N_rho[0.25|0.50|0.75].*"
echo "Time: $(date)"
echo "========================================================================"
