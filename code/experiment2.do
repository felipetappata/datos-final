...
if "`1'" == "" | "`2'" == "" | "`3'" == "" {
    display as error "Usage: stata -b do experiment2.do N model rho [output_dir]"
...
// ========================================================================
// SIMULATION PARAMETERS - EXPERIMENT 2: MORE SAMPLE SELECTION (25%)
// ========================================================================
...
// EXPERIMENT 2 MODIFICATION: Higher selection rate  
local a_param 1.168          // CHANGED: Set so P(d_it* > 0) = 0.75 (25% selection), a=√3*Φ^−1(0.75)≈1.168
...
// Outcome equation parameters (ENDOGENOUS SELECTION - baseline)
...
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 2: MORE SAMPLE SELECTION (25%) - ENDOGENOUS SELECTION"
display as text "========================================================================="
display as text "Parameters: N=`N', Model=`model', rho=`rho', Replications=`reps'"
display as text "EXPERIMENT: More sample selection (25% instead of baseline 15%)"
display as text "Selection: 25% attrition, ENDOGENOUS (theta=`theta_param', vartheta=`vartheta_param')"
...
forvalues rep = 1/`reps' {
    ...
    // ====================================================================
    // DATA GENERATION PROCESS (Same as baseline except selection rate)
    // ====================================================================
...
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 2 SIMULATION COMPLETED"
display as text "========================================================================="
...
matrix Results[1,9] = 2

// Display final results table
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 2 FINAL RESULTS - MORE SAMPLE SELECTION (25%)"
display as text "Model `model', N=`N', rho=`rho'"
display as text "========================================================================="
matrix list Results, format(%9.6f)

// Export results to text file for easier reading
local txt_filename "`output_dir'/exp2_model`model'_N`N'_rho`rho'.txt"
file open txtfile using "`txt_filename'", write replace
file write txtfile "=========================================================================" _n
file write txtfile "EXPERIMENT 2: MORE SAMPLE SELECTION (25%) - TABLE 2 REPLICATION" _n
file write txtfile "AL SADOON ET AL. (2019) - ENDOGENOUS SELECTION RESULTS" _n
file write txtfile "=========================================================================" _n
file write txtfile "Experiment: More sample selection (25% instead of baseline 15%)" _n
...
local filename "exp2_model`model'_N`N'_rho`rho'.dta"
preserve
clear
...
svmat Results, names(col)
gen str model = "`model'"
gen str experiment_type = "exp2_more_selection"
gen str date_time = "`c(current_date)' `c(current_time)'"
local csv_filename "`output_dir'/exp2_model`model'_N`N'_rho`rho'.csv"
...
display as text ""
display as text "========================================================================="
display as text "EXPERIMENT 2 COMPLETE FOR N=`N', MODEL=`model', RHO=`rho'"
display as text "========================================================================="
